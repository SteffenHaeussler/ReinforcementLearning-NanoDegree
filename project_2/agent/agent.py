...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, agent_config, device, random_seed):
        ...
        # Replay memory
        self.memory = ReplayBuffer(action_size, self.config['BUFFER_SIZE'], self.config['BATCH_SIZE'], self.device, random_seed)
